...
void Hash_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Hash_2_run(uint ctx_index,Circom_CalcWit* ctx);
...
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 319
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[1],&lvar[221],&circuitConstants[1]); // line circom 320
Fr_eq(&expaux[2],&lvar[221],&circuitConstants[437]); // line circom 320
Fr_lor(&expaux[0],&expaux[1],&expaux[2]); // line circom 320
...
PFrElement aux_dest = &lvar[220];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 323
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 1)]);
}
}
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 325
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[219];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 2]); // line circom 325
// end load src
...
PFrElement aux_dest = &lvar[219];
// load src
Fr_sub(&expaux[3],&lvar[221],&circuitConstants[3]); // line circom 325
Fr_add(&expaux[1],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[3])) + 445)]); // line circom 325
Fr_add(&expaux[0],&expaux[1],&lvar[220]); // line circom 325
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
// load src
Fr_mul(&expaux[0],&lvar[219],&lvar[219]); // line circom 326
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)]); // line circom 327
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[437]); // line circom 328
if(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 329
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[222];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 329
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 225)],&lvar[219]); // line circom 330
Fr_add(&expaux[0],&lvar[222],&expaux[2]); // line circom 330
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 331
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 664)];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 331
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + 444],&lvar[219]); // line circom 333
Fr_add(&expaux[0],&signalValues[mySignalStart + 882],&expaux[2]); // line circom 333
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[221];
// load src
Fr_add(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 319
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 319
...
Fr_eq(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 63
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 2]); // line circom 67
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "newHash";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
for (uint i = 0; i < 7; i++) {
std::string new_cmp_name = "components"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
Hash_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 1773 ;
aux_cmp_num += 4;
}
}
...
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[31]); // line circom 12
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[((1 * Fr_toInt(&lvar[18])) + 1)];
// load src
// end load src
...
PFrElement aux_dest = &lvar[18];
// load src
Fr_add(&expaux[0],&lvar[18],&circuitConstants[3]); // line circom 12
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[31]); // line circom 12
...
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[15]); // line circom 18
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[18];
// load src
Fr_add(&expaux[0],&lvar[18],&circuitConstants[3]); // line circom 18
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[15]); // line circom 18
...
Fr_gt(&expaux[0],&lvar[18],&circuitConstants[1]); // line circom 25
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[0],&lvar[18],&circuitConstants[3]); // line circom 26
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 1)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Hash_2_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&lvar[18])) + 1)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Hash_2_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_sub(&expaux[1],&lvar[18],&circuitConstants[5]); // line circom 28
Fr_div(&expaux[0],&expaux[1],&circuitConstants[5]); // line circom 28
{
PFrElement aux_dest = &lvar[((1 * Fr_toInt(&expaux[0])) + 1)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[17])) + 0)]].signalStart + 0]);
}
{
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[3]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[18];
// load src
Fr_sub(&expaux[0],&lvar[18],&circuitConstants[5]); // line circom 25
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_gt(&expaux[0],&lvar[18],&circuitConstants[1]); // line circom 25
...
GetMerkleRoot_3_create(1,0,ctx,"main",0);
GetMerkleRoot_3_run(0,ctx);
}
